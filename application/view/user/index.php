		...
		<div class="col s12 teal darken-1">
			<ul class="collapsible" data-collapsible="accordion">
    			<li>
     				...
     				<div class="collapsible-body"><p><?=$fileData->description ?></p></div>
     				<?php 
     					}
     				...
     				<form method="post" action="<?= config::get("URL"); ?>user/addComment">
							...
							<textarea placeholder="voeg hier een comment toe" name="comment" required="true"><?=$fileData->description ?></textarea>
